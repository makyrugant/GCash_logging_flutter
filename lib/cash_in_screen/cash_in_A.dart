...
class _CashInScreenState extends State<CashInScreen> {
  ...
  final TextEditingController inDateAddedController = TextEditingController();
  ...
  final TextEditingController infeeController = TextEditingController();
  final TextEditingController indiscountController = TextEditingController();
  @override
  void initState() {
    super.initState();
    indateController.text = DateTime.now().toString().split(' ')[0];
    inDateAddedController.text = DateTime.now().toString().split(' ')[0];
  ...
  void _recalculateFee() {
    ...
    infeeController.text = fee.toString();
  }

  void _recomputeFee() {
    final feeRaw = infeeController.text.replaceAll(RegExp(r'[^0-9]'), '');
    final discRaw = indiscountController.text.replaceAll(RegExp(r'[^0-9]'), '');
    ...
    infeeController.text = result.toString();
  }
  ...
  void _onDiscountChanged(String value) {
    ...
    if (discount > maxDiscount) {
      indiscountController.text = maxDiscount.toString();
      indiscountController.selection = TextSelection.collapsed(
        offset: indiscountController.text.length,
      );
    }
    _recalculateFee();
    _recomputeFee();
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      controller: inDateAddedController,
                      textAlign: TextAlign.center,
                      decoration: InputDecoration(
                        suffixIcon: IconButton(
                          ...
                          onPressed: () {
                            final now = DateTime.now();
                            inDateAddedController.text = now.toString().split(
                              ' ',
                            )[0];
                          },
                        ),
                      ...
                      onTap: () async {
                        ...
                        if (picked != null) {
                          inDateAddedController.text = picked.toString().split(
                            ' ',
                          )[0];
                        }
                      },
                        ...
                        Expanded(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 8),
                              TextFormField(
                                controller: indiscountController,
                                keyboardType: TextInputType.number,
