                ...
                children: [
                  ...
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          _buildLabelValue('Transaction Date', date),
                          _buildLabelValue('Date Added', dateAdded),
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(child: _buildLabelValue('Fee', fee)),
                              const SizedBox(width: 8),
                              Expanded(
                                child: _buildLabelValue('Discount', dscnt),
                              ),
                            ],
                          ),
                        ],
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            await repository.addTransaction(
                              ...
                              fee: fee,
                              dscnt: dscnt,
                              userSelectedDateAdded: DateTime.tryParse(
                                dateAdded,
                              ),
                            );
